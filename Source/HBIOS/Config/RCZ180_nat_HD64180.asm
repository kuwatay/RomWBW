...
CPUOSC		.SET	24576000	; CPU OSC FREQ IN MHZ (24.576MHz/2)
ASCI0CFG	.EQU	SER_38400_8N1 | SER_RTS	; ASCI 0: SERIAL LINE CONFIG
ASCI1CFG	.EQU	SER_38400_8N1 | SER_RTS	; ASCI 1: SERIAL LINE CONFIG
;
